import controller.RestApplication;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        // docker compose starts everything at once. db has slower startup, so wait before connecting
        System.out.println("About to sleep 10 seconds (making sure DB is up)");
        try {
            Thread.sleep(10000);
        ...
        runTestQuery(new SearchRequest.Builder().poi(p0).distance(100).build(), false);
           */
        // IMPORTANT: do NOT use DBZugriff directly!
        // Use Controller.java instead!!!
        /*
